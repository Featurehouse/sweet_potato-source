...
import io.featurehouse.spm.blocks.entities.MagicCubeBlockEntity.FireBelow;
...
import static io.featurehouse.spm.util.properties.objects.Tags.inTag;
        ...
        this.stateHelper = new BooleanStateManager(MagicCubeBlock.ACTIVATED) {
            ...
            public void run() {
                ...
                if (this.shouldChange(b = fc > 0)) {
                    MagicCubeBlockEntity.this.world.setBlockState(pos,
                            MagicCubeBlockEntity.this.world.getBlockState(pos)
                                    .with(property, b));
                    if (!b) {
                        MagicCubeBlockEntity.this.mainFuelTime = -1;
                        MagicCubeBlockEntity.this.viceFuelTime = 0;
                        MagicCubeBlockEntity.this.world.playSound(null, pos,
