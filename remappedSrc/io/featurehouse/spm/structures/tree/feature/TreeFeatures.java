...
import io.featurehouse.spm.structures.tree.feature.TreeFeatures.BlockStates;
...
public final class TreeFeatures {
    ...
    static {
        ...
        OAK = register("oak", Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockStates.OAK_LOG), new SimpleBlockStateProvider(ENCHANTED_OAK_LEAVES), new BlobFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1)).ignoreVines().build()));
