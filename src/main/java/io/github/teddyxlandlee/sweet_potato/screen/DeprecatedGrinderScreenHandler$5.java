...
@Deprecated
public class DeprecatedGrinderScreenHandler$5 extends ScreenHandler {
    private final Inventory inventory;
    private PropertyDelegate propertyDelegate;
    protected final World world;
    protected GrinderBlockEntity blockEntity;

    public DeprecatedGrinderScreenHandler$5(@Nullable ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory) {
        this(type, syncId, playerInventory, new SimpleInventory(2), /*new ArrayPropertyDelegate(3)*/ null);
    }

    public DeprecatedGrinderScreenHandler$5(ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(type, syncId);
    ...
    @Deprecated
    public DeprecatedGrinderScreenHandler$5(int i, PlayerInventory playerInventory, PacketByteBuf packetByteBuf) {
