...
@Deprecated
public class DeprecatedGrinderScreen$3 extends HandledScreen<GrinderScreenHandler> {
    ...
    public DeprecatedGrinderScreen$3(GrinderScreenHandler handler, PlayerInventory inventory, Text title) {
