...
public final class FloatIntegerizer {
    ...
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Usage: java FloatIntegerizer <--fromFloat / -FF / -TI | --toFloat / -FI / -TF> <value>");
        } else if (args[0].equalsIgnoreCase("-fromfloat") || args[0].equalsIgnoreCase("-FF") || args[0].equalsIgnoreCase("-TI")) {
            float from;
            int to;
            float check;
            try {
        ...
        } else if (args[0].equalsIgnoreCase("-tofloat") || args[0].equalsIgnoreCase("FI") || args[0].equalsIgnoreCase("-TF")) {
            int from;
            float to;
            int check;
            try {
