...
public class VillagerLootTables {
    private static final LootNumberProvider universalPotatoRange = UniformLootNumberProvider.create(1.0F, 7.0F);
    ...
    public static void snowy(LootSupplierBuilderHooks builderHooks) {
        ...
        entries.set(3, ItemEntry.builder(Items.BREAD).weight(7).apply(
                SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))).build());
