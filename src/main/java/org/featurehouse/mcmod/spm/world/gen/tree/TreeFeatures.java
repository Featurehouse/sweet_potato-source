...
public final class TreeFeatures {
    ...
    static {
        FANCY_OAK = register("fancy_oak",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                ...
                                new SimpleBlockStateProvider(ENCHANTED_OAK_SAPLING),
                                new LargeOakFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(4), 4),
                                new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4))))
                                .ignoreVines().build()));
        FANCY_OAK_BEES_005 = register("fancy_oak_bees_005",
                Feature.TREE.configure(FANCY_OAK.getConfig().setTreeDecorators(ImmutableList.of(MORE_BEEHIVES_TREES))));
        OAK = register("oak",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                new SimpleBlockStateProvider(OAK_LOG),
        ...
        OAK_BEES_005 = register("oak_bees_005",
                Feature.TREE.configure(OAK.getConfig().setTreeDecorators(ImmutableList.of(MORE_BEEHIVES_TREES))));
        SPRUCE = register("spruce",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                new SimpleBlockStateProvider(SPRUCE_LOG),
                                new StraightTrunkPlacer(5, 2, 1),
                                new SimpleBlockStateProvider(ENCHANTED_SPRUCE_LEAVES),
                                new SimpleBlockStateProvider(ENCHANTED_SPRUCE_SAPLING),
        ...
        MEGA_PINE = register("mega_pine",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                ...
                                .decorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(PODZOL))))
                                .build()));
        BIRCH = register("birch",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                new SimpleBlockStateProvider(BIRCH_LOG),
                                new StraightTrunkPlacer(5, 2, 0),
                                new SimpleBlockStateProvider(ENCHANTED_BIRCH_LEAVES),
                                new SimpleBlockStateProvider(ENCHANTED_BIRCH_SAPLING),
                                new BlobFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3),
                                new TwoLayersFeatureSize(1, 0, 1)))
                                .ignoreVines().build()));
        BIRCH_BEES_005 = register("birch_bees_005",
                Feature.TREE.configure(BIRCH.getConfig().setTreeDecorators(ImmutableList.of(MORE_BEEHIVES_TREES))));
        JUNGLE_TREE_NO_VINE = register("jungle_tree_no_vine",
                Feature.TREE.configure((new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                        new SimpleBlockStateProvider(JUNGLE_LOG), new StraightTrunkPlacer(4, 8, 0),
                        new SimpleBlockStateProvider(ENCHANTED_JUNGLE_LEAVES),
                        new SimpleBlockStateProvider(ENCHANTED_JUNGLE_SAPLING),
                        new BlobFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3),
                        new TwoLayersFeatureSize(1, 0, 1)))
                        .ignoreVines().build()));
        ...
        ACACIA = register("acacia",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                ...
                                new SimpleBlockStateProvider(ENCHANTED_ACACIA_LEAVES),
                                new SimpleBlockStateProvider(ENCHANTED_ACACIA_SAPLING),
        ...
        DARK_OAK = register("dark_oak",
                Feature.TREE.configure(
                        (new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(
                                ...
                                new SimpleBlockStateProvider(ENCHANTED_DARK_OAK_LEAVES),
                                new SimpleBlockStateProvider(ENCHANTED_DARK_OAK_SAPLING),
