...
public class GrinderScreenHandler extends YwsuoyiScreenHandler {
    private final PropertyDelegate propertyDelegate;
    protected final World world;

    public GrinderScreenHandler(ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, Inventory inventory, PacketByteBuf packetByteBuf) {
